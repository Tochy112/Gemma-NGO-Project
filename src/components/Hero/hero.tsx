  ...
  return (
    <div className='grid lg:grid-cols-2 gap-y-5 pb-12 pt-20 bg-[#70A5D4] lg:text-start text-center lg:px-20 px-5'>
      <div>
        ...
        Safeguarding Somerset is our number 1 priority
        </h1>
      <h2 className='font-bold lg:text-2xl text-lg mb-9'>
        Working in partnership to enable adults in Somerset to live a life free from fear, harm and abuse
      </h2>

      <button className='lg:p-5 p-3 bg-black text-white rounded-lg '>Hello world</button>
      </div>
